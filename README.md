# Remark 
This repository was forked from [GnuTLS official](https://gitlab.com/gnutls/gnutls/) repository.  
All the changes applied to it consist on a team project for the [PV204](https://is.muni.cz/course/fi/spring2019/PV204) course in Faculty of Informatics of Masaryk University. Our tasks include: Analyses of keys(RSA, ECC) generation times, adding or trying out support for smart cards, and others.  
